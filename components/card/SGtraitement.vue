    ...
    <div class="card-content">
      <div class="card card-generated" @click="handleClick('pending')">
        <div class="card-number">
          <h2 class="number">{{ traitements.length }}</h2>
          <svg
      ...
      <div class="card card-validated" @click="handleClick('validated')">
        <div class="card-number">
          <h2 class="number">{{ traiteds.length || 0 }}</h2>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true"
            role="img"
    ...
    <div class="missions-orders mt-5">
      <div v-show="active === 'pending'">
        <div class="missions-orders__header">
          <h2>les Ordres de mission à traiter</h2>
        </div>
...
export default {
  ...
  computed: {
    ...
    traitements() {
      return getMissionsBylevel(this.allMissions, 'SG')
    },
    traiteds() {
      return getMissionsBylevel(this.allMissions, 'CF')
    },
  },
  mounted() {
